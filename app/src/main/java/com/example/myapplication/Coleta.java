...
public class Coleta extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_coleta_seletiva_musica";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.coleta);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoColeta);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Coleta Seletiva concluída! ♻️", Toast.LENGTH_SHORT).show();
                } else {
