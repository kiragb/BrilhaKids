...
public class Selvagens extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_animais_selvagens_video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selvagens);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.selvagensvideo);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoSelvagens);
        preferences = getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);

        // Carrega estado anterior do CheckBox
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Incrível! Lição de Animais Selvagens concluída. 🦁", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        File pdfFile = new File(getCacheDir(), "atividade-animais-selvagens.pdf");
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.servagenspdf);
