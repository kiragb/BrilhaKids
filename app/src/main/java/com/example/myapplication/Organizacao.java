...
public class Organizacao extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_organizacao";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.organizacaovideo);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoOrganizacao);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Lição de organização concluída! ✨", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        File pdfFile = new File(getCacheDir(), "organizacao.pdf");
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.organizacao);
