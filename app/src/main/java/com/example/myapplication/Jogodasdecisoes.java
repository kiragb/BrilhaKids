...
public class Jogodasdecisoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogodasdecisoes);
        ...
        // Supondo que o id no seu XML seja checkboxConcluidoDecisoes
        checkboxConcluido = findViewById(R.id.checkboxConcluidoDecisoes);
        ...
        boolean jaConcluido = preferences.getBoolean("concluido_jogo_decisoes", false);
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                // 1. Salva o estado individual desta página específica
                editor.putBoolean("concluido_jogo_decisoes", isChecked);
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Decisão tomada! Jogo concluído! ✨", Toast.LENGTH_SHORT).show();
                } else {
