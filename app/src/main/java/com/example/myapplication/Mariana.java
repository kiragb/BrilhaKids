...
public class Mariana extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_mariana_musica";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.marianna);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoMariana);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Mariana conta 1... Música concluída! 🎶", Toast.LENGTH_SHORT).show();
                } else {
