...
public class Reciclar extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_reciclar_video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.reciclarvideo);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoReciclar);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Parabéns! Reciclagem concluída. ✨", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        File pdfFile = new File(getCacheDir(), "atividade-reciclar.pdf");
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.reciclar);
