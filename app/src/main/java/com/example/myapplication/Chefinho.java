...
public class Chefinho extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_chefinho_mandou_video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chefinho);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.chefe);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoChefinho);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                // Atualiza o total de MÚSICAS concluídas para o gráfico do perfil
                int totalAtual = preferences.getInt(KEY_TOTAL_MUSICAS, 0);
                if (isChecked) {
                    editor.putInt(KEY_TOTAL_MUSICAS, totalAtual + 1);
                    Toast.makeText(this, "Música concluída! Chefinho mandou muito bem! ✨", Toast.LENGTH_SHORT).show();
                } else {
