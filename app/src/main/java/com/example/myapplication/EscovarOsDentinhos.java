...
public class EscovarOsDentinhos extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_escovar_dentinhos";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoEscovar);
        sharedPreferences = getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);

        // Carrega estado anterior
        boolean isConcluido = sharedPreferences.getBoolean(KEY_CHECK_LOCAL, false);
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                int totalAtual = sharedPreferences.getInt(KEY_TOTAL_LICOES, 0);
                if (isChecked) {
                    editor.putInt(KEY_TOTAL_LICOES, totalAtual + 1);
                    Toast.makeText(this, "Parabéns! Lição concluída. ✨", Toast.LENGTH_SHORT).show();
                } else {
