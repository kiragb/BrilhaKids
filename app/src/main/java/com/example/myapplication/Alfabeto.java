...
public class Alfabeto extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_xuxa_alfabeto_video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoXuxa);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "A de amor! Alfabeto concluído! 🎵", Toast.LENGTH_SHORT).show();
                } else {
