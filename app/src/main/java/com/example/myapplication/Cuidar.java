...
public class Cuidar extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_cuidar_natureza";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.cuidar);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoAmbiente);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Natureza agradece! Lição concluída. ✨", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        File pdfFile = new File(getCacheDir(), "atividade-preservar-natureza.pdf");
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.cuidarpdf);
