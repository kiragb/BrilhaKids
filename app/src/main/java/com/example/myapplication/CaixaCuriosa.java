...
public class CaixaCuriosa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean jaConcluido = preferences.getBoolean("concluido_caixa_curiosa", false);
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                editor.putBoolean("concluido_caixa_curiosa", isChecked);
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Caixa Curiosa finalizada! +1 no Perfil! ✨", Toast.LENGTH_SHORT).show();
                } else {
