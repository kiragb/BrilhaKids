...
public class Formas extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_formas_geometricas_video";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.formas);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoFormas);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Boa! Lição de Formas concluída. 🟦🟡", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        // Nome do arquivo de cache corrigido para Formas
        File pdfFile = new File(getCacheDir(), "atividade-formas-geometricas.pdf");
        try {
            // ID do recurso raw corrigido para Formas
