...
public class Domesticos extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_animais_domesticos";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.domesticosvideo);
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoDomesticos);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Lição de Animais Domésticos concluída! 🐾", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        File pdfFile = new File(getCacheDir(), "atividade-animais-domesticos.pdf");
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.domesticospdf);
