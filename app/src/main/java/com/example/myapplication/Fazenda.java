...
public class Fazenda extends AppCompatActivity {
    ...
    private static final String KEY_CHECK_LOCAL = "concluido_animais_fazenda";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkboxConcluido = findViewById(R.id.checkboxConcluidoFazenda);
        ...
        if (checkboxConcluido != null) {
            ...
            checkboxConcluido.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(this, "Lição de Animais da Fazenda concluída! 🐄", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void openPdf() {
        File pdfFile = new File(getCacheDir(), "atividade-animais-fazenda.pdf");
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.fazendapdf);
